...
* PROGRAM NAME:   	f_cgis_plotchange
...
%fig(dset=adqs,paramcd=%str("CGI0201"));
...
layout overlay / xaxisopts=( LABEL= ('Visit') labelattrs=(family='Courier New' size=7pt )
	...
	yaxisopts=(  LABEL= ('Change from Baseline CGI-S Total Score') labelattrs=(family='Courier New' size=7pt ));
