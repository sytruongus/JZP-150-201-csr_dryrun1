...
* PROGRAM NAME:   	f_pgis_plotchange
...
%fig(dset=adqs,paramcd=%str("PGI0101"));
...
layout overlay / xaxisopts=( LABEL= ('Visit') labelattrs=(family='Courier New' size=7pt )
	...
	yaxisopts=(  LABEL= ('Change from Baseline PGI-S Total Score') labelattrs=(family='Courier New' size=7pt ));
