...
* PROGRAM NAME:   	f_caps_forest_subg
...
proc sql;
   create table caps as 
       ...
       from adam.adqs where paramcd="PTSDTSEV" and .<avisitn<=12 and mfasfl="Y" and anl01fl="Y" 
...
proc sql;
   create table caps_visittyp as 
       ...
       from adam.adqs where paramcd="PTSDTSEV" and .<avisitn<=12 and mfasfl="Y" and anl01fl="Y"  and VISITTYP ne ""
