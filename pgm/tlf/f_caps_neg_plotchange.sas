...
* PROGRAM NAME:   	f_caps_neg_plotchange
...
%fig(dset=adqs,paramcd=%str("CA5DTOSV"));
...
layout overlay / xaxisopts=( LABEL= ('Visit') labelattrs=(family='Courier New' size=7pt )
	...
	yaxisopts=(  LABEL= ('Change from Baseline Negative Alterations Mood/Cognition') labelattrs=(family='Courier New' size=7pt ));
