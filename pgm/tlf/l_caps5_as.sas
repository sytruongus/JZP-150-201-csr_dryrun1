...
proc sort data=adam.adqs out=adqs_01(keep= usubjid subjid avisit visit adt ady anl01fl chg paramcd avalc);
	...
	where saffl ='Y' and paramcd in  ('CA5CTOSV') and dtype='';
run;
proc sort data=adam.adqs out=adqs_02(keep= usubjid subjid SSNRIS visit avisit adt ady paramcd param age sex race trta trtsdt trtedt avalc);
	...
	where saffl ='Y' and paramcd in  ("C57C2SEV","CA56C1SE") and dtype='';
run;
...
data qs;
	...
	var10 = strip(CA56C1SE);
	var11 = strip(C57C2SEV);
...
label
	...
	var8= 'Avoidance |Symptoms |Subscale |Score'
	var9= 'Change |from |Baseline'
	var10= 'Avoidance |memories,|thoughts,|feelings-Sev |Score'
	var11= 'Avoidance |of Ext. |reminders - |Severity |Score'
	;
...
proc sort data =  qs;
	by SSNRIS trta var1 var2 var3 var4 var5 var6 var7 var8 var9 var10 var11 ;
run;
data qs;
	set qs;
	by SSNRIS trta var1 var2 var3 var4 var5 var6 var7 var8 var9 var10 var11 ;
...
proc sort data=JM_AVAL_ALLREPORT;
    by pageno SSNRIS trta var1 var2 var3 var4 var5 var6 var7 var8 var9 var10 var11 ;
	where usubjid^='';
run;
...
,JM_CELLWIDTH= 0.4 0.35 0.5 0.65 0.5  0.3  0.35 0.4 0.4 0.4 0.4 
