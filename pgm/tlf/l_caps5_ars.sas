...
proc sort data=adam.adqs out=adqs_01(keep= usubjid subjid avisit visit adt ady anl01fl chg paramcd avalc);
	...
	where saffl ='Y' and paramcd in  ('CA5ETOSV') and dtype='';
run;
proc sort data=adam.adqs out=adqs_02(keep= usubjid subjid SSNRIS visit avisit adt ady parcat1 parcat2 paramcd param age sex race trta trtsdt trtedt avalc);
	...
	where saffl ='Y' and parcat2 = "CRITERION E- AROUSAL AND REACTIVITY" and  paramcd in  ( "C516E2SE", "C516E5SE", "C515E1SE", "C516E3SE","C516E6SE","C516E4SE") and dtype='';
run;
...
data qs;
	...
	var10 = strip(C515E1SE);
	var11 = strip(C516E2SE);
	var12 = strip(C516E3SE);
	var13 = strip(C516E4SE);
	var14 = strip(C516E5SE);
	var15 = strip(C516E6SE);
...
label
	...
	var8= 'Intrusive |Symptoms |Subscale |Score'
	var9= 'Change |from |Baseline'
	var10= 'Irritable |behavior/angry |outbursts-Sev |Score'
	var11= 'Reckless/|self-destructive |behavior-Sev |Score'
	var12= 'E3 |Hypervigilance - |Severity |Score'
	var13= 'Exaggerated |startle |response - |Severity |Score'
	var14= 'Problems |with |concentration - |Severity |Score'
	var15= 'E6 |Sleep |disturbance - |Severity |Score';
...
proc sort data =  qs;
	by SSNRIS trta var1 var2 var3 var4 var5 var6 var7 var8 var9 var10 var11 var12 var13 var14 var15;
run;
data qs;
	set qs;
	by SSNRIS trta var1 var2 var3 var4 var5 var6 var7 var8 var9 var10 var11 var12 var13 var14 var15;
...
proc sort data=JM_AVAL_ALLREPORT;
    by pageno SSNRIS trta var1 var2 var3 var4 var5 var6 var7 var8 var9 var10 var11 var12 var13 var14 var15;
	where usubjid^='';
run;
...
,JM_COL2VAR=  var1 var2 var3 var4 var5 var6 var7 var8 var9 var10 var11 var12 var13 var14 var15
,JM_CELLWIDTH= 0.4 0.35 0.5 0.65 0.5  0.3  0.35 0.4 0.4 0.4 0.4  0.4  0.4 0.4 0.4
