...
%macro t_lab_shift_ser_chem_saffl( TRTVAR=, ADSL_SUBSET=%str(trt01aN in (1,2,3) and saffl='Y'), ADLB_SUBSET=%STR(trtaN in (1,2,3) and ANL01FL='Y'),
...
%mend t_lab_shift_ser_chem_saffl;

%t_lab_shift_ser_chem_saffl(TRTVAR=TRTA, postbase_avisitn=%str(1,4,8,12,92), base_avisitn=%str(0,-1),
   ADLB_SUBSET=%STR(&TRTVAR.N in (1,2,3) and saffl='Y' and parcat1="Chemistry" and ANL01FL='Y' and anl05fl='Y'),
