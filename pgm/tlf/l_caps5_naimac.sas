...
*Body of table;
*-----------------------------------------------------------------;
proc sort data=adam.adqs out=adqs_01(keep= usubjid subjid avisit visit adt ady anl01fl chg paramcd avalc);
	by usubjid subjid visit avisit adt;
	where saffl ='Y' and paramcd in  ('CA5DTOSV') and dtype='';
run;
proc sort data=adam.adqs out=adqs_02(keep= usubjid subjid SSNRIS visit avisit adt ady parcat1 parcat2 paramcd param age sex race trta trtsdt trtedt avalc);
	by trta SSNRIS usubjid subjid visit avisit adt age sex race trtsdt trtedt;
	where saffl ='Y' and  paramcd in  ( "C510D3SE" "C511D4SE" "C512D5SE" "C513D6SE" "C514D7SE" "C58D1SEV" "C59D2SEV") and dtype='';
run;
...
data qs;
	...
	var10 = strip(C58D1SEV);
	var11 = strip(C59D2SEV);
	var12 = strip(C510D3SE);
	var13 = strip(C511D4SE);
	var14 = strip(C512D5SE);
	var15 = strip(C513D6SE);
	var16 = strip(C514D7SE);
...
label
	...
	var8= 'Cognitions |subtotal - |Severity |Score'
	var9= 'Change |from |Baseline'
	var10= 'D1-Inability |to recall |imp. event-Sev |Score'
	var11= 'Exaggerated |neg. beliefs/|expectation-Sev |Score'
	var12= 'Distorted |cognitions |leading |blame-Sev |Score'
	var13= 'Persistent |negative |emotional |state-Sev |Score'
	var14= 'Diminish |Intrst/|participate |in Act.-Sev |Score'
	var15= 'Detachment/|estrangement |from |others-Sev'
	var16= 'Inability |to Exp Pos. |Emotions- |Severity |Score';
...
proc sort data =  qs;
	by SSNRIS trta var1 var2 var3 var4 var5 var6 var7 var8 var9 var10 var11 var12 var13 var14 var15 var16;
run;
data qs;
	set qs;
	by SSNRIS trta var1 var2 var3 var4 var5 var6 var7 var8 var9 var10 var11 var12 var13 var14 var15 var16;
...
proc sort data=JM_AVAL_ALLREPORT;
    by pageno SSNRIS trta var1 var2 var3 var4 var5 var6 var7 var8 var9 var10 var11 var12 var13 var14 var15 var16;
	where usubjid^='';
run;
...
,JM_COL2VAR=  var1 var2 var3 var4 var5 var6 var7 var8 var9 var10 var11 var12 var13 var14 var15 var16
,JM_CELLWIDTH= 0.4 0.35 0.5 0.65 0.5  0.3  0.35 0.4 0.4 0.4 0.4  0.4  0.4 0.4 0.4 0.4
