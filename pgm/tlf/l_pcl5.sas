...
proc sort data=adam.adqs2 out=adqs_01(keep= usubjid subjid avisit visit adt ady anl01fl chg paramcd aval);
	...
	where saffl ='Y' and paramcd in  ('PCL0125') ;*and dtype='';
run;
proc sort data=adam.adqs2 out=adqs_02(keep= usubjid subjid SSNRIS visit avisit adt ady parcat1 parcat2 paramcd param age sex race trta trtsdt trtedt aval);
	by trta SSNRIS usubjid subjid visit avisit adt paramcd age sex race trtsdt trtedt ;
	where saffl ='Y' and  paramcd in  ( "PCL0121" "PCL0122" "PCL0123" "PCL0124") ;*and dtype='';
run;
...
label
	...
	var8= 'PCL01-Total |Score'
	var9= 'Change |from |Baseline'
	var10= 'ClusterB |Score'
	var11= 'ClusterC |Score'
	var12= 'ClusterD |Score'
	var13= 'ClusterE |Score'
;
