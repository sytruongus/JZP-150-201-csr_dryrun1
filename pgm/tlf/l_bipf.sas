...
proc sort data=adam.adqs2 out=adqs_01(keep= usubjid subjid avisit visit adt ady anl01fl chg paramcd aval);
	...
	where saffl ='Y' and paramcd in  ('BIPF108') ;*and dtype='';
run;
proc sort data=adam.adqs2 out=adqs_02(keep= usubjid subjid SSNRIS visit avisit adt ady parcat1 parcat2 paramcd param age sex race trta trtsdt trtedt aval);
	...
	where saffl ='Y' and  paramcd in  ( "BIPF101" "BIPF102" "BIPF103" "BIPF104" "BIPF105" "BIPF106" "BIPF107") ;*and dtype='';
run;
...
label
	...
	var8= 'BIPF1-Total |Score'
	var9= 'Change |from |Baseline'
	var10= 'Romantic Relation with my Spouse |Score'
	var11= 'Relationship with my Children |Score'
	var12= 'Family Relationships |Score'
	var13= 'Trouble with Friendships |Score'
	var14= 'Trouble at Work |Score'
	var15= 'Trouble with Training |Score'
	var16= 'Trouble with day to day Activities |Score';
