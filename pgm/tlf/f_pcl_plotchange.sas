...
%fig(dset=adqs2,paramcd=%str("PCL0125"));
...
layout overlay / xaxisopts=( LABEL= ('Visit') labelattrs=(family='Courier New' size=7pt )
	...
	yaxisopts=(  LABEL= ('Change from Baseline PCL-5 Total Score') labelattrs=(family='Courier New' size=7pt ));
