...
* PROGRAM NAME:   	f_caps_avoid_plotchange
...
%fig(dset=adqs,paramcd=%str("CA5CTOSV"));
...
layout overlay / xaxisopts=( LABEL= ('Visit') labelattrs=(family='Courier New' size=7pt )
	...
	yaxisopts=(  LABEL= ('Change from Baseline Avoidance Symptoms') labelattrs=(family='Courier New' size=7pt ));
