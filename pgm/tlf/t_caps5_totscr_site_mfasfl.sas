...
DATA ADQS ;
 SET adam.ADQS ;
  ...
  where /*TRT01AN in (1,2,3) and  MFASFL='Y' and */ paramcd in ("PTSDTSEV") and avisitn in (0,12); 
...
class trtn avisitn SSNRISN;
model chg=trtn avisitn SSNRISN base;
