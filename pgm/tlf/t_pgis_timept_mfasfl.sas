...
options orientation=landscape missing=' ' nodate nonumber;
   ...
   *** Create a macro variable for storing ADQS dataset name from the list of datasets ***;                             
   data ADQS ;                             
      set adam.ADQS ;                             
      where /*TRT01AN in (1,2,3) and  MFASFL='Y' and */ paramcd in ("PGI0101") and avisitn in (0,1,4,8,12,92) and anl01fl="Y" and MFASFL="Y"; 
 ...
 *** Create Treatment formats for reporting ***;
 ...
 %JM_AVAL_COUNT(JM_INDSN=target, jm_var= aval, JM_SECONDARY_WHERE= avalc ne "" and avisitn=0, jm_bign=jm_bign1, jm_trtvarn=trtn,JM_FMT=pgis.,
 ...
 *** Create Treatment formats for reporting ***;
 ...
 %JM_AVAL_COUNT(JM_INDSN=target, jm_var= aval, JM_SECONDARY_WHERE= avalc ne "" and avisitn=1, jm_bign=jm_bign1, jm_trtvarn=trtn,JM_FMT=pgis.,
 ...
 *** Create Treatment formats for reporting ***;
 ...
 %JM_AVAL_COUNT(JM_INDSN=target, jm_var= aval, JM_SECONDARY_WHERE= avalc ne "" and avisitn=4, jm_bign=jm_bign1, jm_trtvarn=trtn,JM_FMT=pgis.,
 ...
 *** Create Treatment formats for reporting ***;
 ...
 %JM_AVAL_COUNT(JM_INDSN=target, jm_var= aval, JM_SECONDARY_WHERE= avalc ne "" and avisitn=8, jm_bign=jm_bign1, jm_trtvarn=trtn,JM_FMT=pgis.,
 ...
 *** Create Treatment formats for reporting ***;
 ...
 %JM_AVAL_COUNT(JM_INDSN=target, jm_var= aval, JM_SECONDARY_WHERE= avalc ne "" and avisitn=12, jm_bign=jm_bign1, jm_trtvarn=trtn,JM_FMT=pgis.,
 ...
 *** Create Treatment formats for reporting ***;
 ...
 %JM_AVAL_COUNT(JM_INDSN=target, jm_var= aval, JM_SECONDARY_WHERE= avalc ne "" and avisitn=92, jm_bign=jm_bign1, jm_trtvarn=trtn,JM_FMT=pgis.,
