...
*Body of table;
*-----------------------------------------------------------------;
proc sort data=adam.adqs out=adqs_01(keep= usubjid subjid avisit visit adt ady anl01fl chg paramcd param avalc aval dtype);
	by usubjid subjid visit avisit adt;
	where saffl ='Y' and parcat1 in  ('CGI' 'PGI') and paramcd in( "CGI0202" "PGI0101" "CGI0201" ) and dtype='';*'MULTIPLE IMPUTATION' ;
run;
proc sort data=adam.adqs out=adqs_02(keep= usubjid subjid SSNRIS visit avisit adt ady anl01fl parcat1 parcat2 visit paramcd param age sex race trta trtsdt trtedt aval avalc);
	by trta SSNRIS usubjid subjid visit avisit adt ady anl01fl paramcd age sex race trtsdt trtedt;
	where saffl ='Y' and parcat1 in  ('CGI' 'PGI') and paramcd in( "CGI0202" "PGI0101" "CGI0201" ) and dtype='' and aval^=.;
run;
...
proc transpose data=adqs_02 out=adqs_t;
	by trta SSNRIS usubjid subjid visit avisit adt ady anl01fl age sex race trtsdt trtedt ;
	id paramcd;
	var aval;
run;
...
data qs;
	...
	var3 =  strip(visit);
	var4 = strip(put(adt,yymmdd10.))||" ("||strip(put(ady,best.))||")";
...
label
	...
	var2="Age/|Sex/|Race"
	var3="Visit"
	var4='Date of |Assessment |(Study Day)'
	var5= 'Visit |Used for |Analysis |(Y/N)/ |Analysis |Visit' 

	var6= 'D1-Inability |to recall |imp. event-Sev |Score'
	var7= 'Exaggerated |neg. beliefs/|expectation-Sev |Score'
	var8= 'Distorted |cognitions |leading |blame-Sev |Score'
;
...
proc sort data =  qs;
	by SSNRIS trta var1 var2 var3 var4 var5 var6 var7 var8 ;
run;
data qs;
	set qs;
	by SSNRIS trta var1 var2 var3 var4 var5 var6 var7 var8 ;
...
proc sort data=JM_AVAL_ALLREPORT;
    by pageno SSNRIS trta var1 var2 var3 var4 var5 var6 var7 var8 ;
	where usubjid^='';
run;
...
,JM_CELLWIDTH= 0.4 0.35 0.5 0.65 0.5  0.4 0.4 0.4 
