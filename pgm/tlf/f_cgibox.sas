...
* DATE CREATED:   	23NOV2022
* PROGRAM NAME:   	f-cgibox
...
where parcat1="CGI" and paramcd="CGI0201"  and chg ne . and avisit="Week 12" and MFASFL="Y" and anl01fl="Y" order by trtan,chg;
quit;
...
/*layout lattice / rowdatarange=data columndatarange=data rowgutter=10 columngutter=10;*/
	...
	yaxisopts=( LABEL= "Change in CGI-S" labelfitpolicy=splitalways labelsplitchar='*'  offsetmin=0.05 
