...
*Body of table;
*-----------------------------------------------------------------;
proc sort data=adam.adqs2 out=adqs_01(keep= usubjid subjid SSNRIS visit avisit adt ady parcat1 parcat2 paramcd param age sex race trta trtsdt trtedt aval avalc);
	by usubjid subjid avisit adt;
	where saffl ='Y' and parcat1 in ('PSQI' 'PSQI-A') and paramcd in  ('PSQPWSCR' 'PSQDYSCR' 'PSQDBSCR' 'PSQDRSCR' 'PSQSESCR' 'PSQLTSCR' 'PSQMDSCR' 'PSQOVSCR') ;*and dtype='';
run;
...
proc sort data =  qs;
	by var1 var2 var3 var4 var5 var6 var7 var8 var9 ;
run;
data qs;
	set qs;
	by var1 var2 var3 var4 var5 var6 var7 var8 var9 ;
...
%JM_PGBRK (JM_INDSN1=qs, JM_INDSN2=, JM_BREAKCNT=8, JM_CONTOPT=N, JM_GROUPOPT=N, JM_OUTDSN=JM_AVAL_ALLREPORT, JM_REPTYPE=Listing);

proc sort data=JM_AVAL_ALLREPORT;
    by pageno var1 var2 var3 var4 var5 var6 var7 var8 var9;
	where usubjid^='';
run;
...
,JM_COL2VAR=  var1 var2 var3 var4 var5 var6 var7 var8 var9 
,JM_CELLWIDTH= 0.65 0.50 0.75 0.75 0.75  0.3  0.45 2.50 0.65
,JM_BYVAR= 
,JM_BREAKVAR=
,JM_REPTYPE=Listing
