...
* PROGRAM NAME:     f_caps_arousal_plotchange
...
%fig(dset=adqs,paramcd=%str("CA5ETOSV"));
...
layout overlay / xaxisopts=( LABEL= ('Visit') labelattrs=(family='Courier New' size=7pt )
	...
	yaxisopts=(  LABEL= ('Change from Baseline Arousal/Reactivity Symptoms') labelattrs=(family='Courier New' size=7pt ));
