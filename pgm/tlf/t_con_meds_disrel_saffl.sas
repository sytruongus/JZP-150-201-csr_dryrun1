...
%macro t_con_meds_disrel_saffl(trtvar=TRT01A,tab_page_size=14,Tab_Event_Count_YN=N,tab_sort=FREQ,
                       adsl_subset=%str(&TRTVAR.N in (1,2,3) and SAFFL='Y'),
                       adae_subset=%str(&TRTVAR.N in (1,2,3) and SAFFL='Y' and CONMEDFL='Y' and DISRELFL="Y")
                       );
