...
proc sort data=adam.adqs out=adqs_01(keep= usubjid subjid avisit visit adt ady anl01fl chg paramcd avalc);
	...
	where saffl ='Y' and paramcd in  ('PTSDTSEV') and dtype='';
run;
proc sort data=adam.adqs out=adqs_02(keep= usubjid subjid SSNRIS visit avisit adt ady paramcd param age sex race trta trtsdt trtedt avalc);
	...
	where saffl ='Y' and paramcd in  ("CA5BTOSV","CA5CTOSV","CA5DTOSV","CA5ETOSV") and dtype='';
run;
...
data qs;
	...
	var10 = strip(CA5BTOSV);
	var11 = strip(CA5CTOSV);
	var12 = strip(CA5ETOSV);
	var13 = strip(CA5DTOSV);
...
label
	...
	var10= 'Intrusive |Symptoms |Subscale |Score'
	var11= 'Avoidance |Symptoms |Subscale |Score'
	var12= 'Arousal/|Reactivity |Symptoms |Subscale |Score'
	var13= 'Negative |Alterations |in Mood |and |Cognition |Subscale |Score';
...
proc sort data =  qs;
	by SSNRIS trta var1 var2 var3 var4 var5 var6 var7 var8 var9 var10 var11 var12 var13;
run;
data qs;
	set qs;
	by SSNRIS trta var1 var2 var3 var4 var5 var6 var7 var8 var9 var10 var11 var12 var13 ;
...
proc sort data=JM_AVAL_ALLREPORT;
    by pageno SSNRIS trta var1 var2 var3 var4 var5 var6 var7 var8 var9 var10 var11 var12 var13 ;
	where usubjid^='';
run;
...
,JM_COL2VAR=  var1 var2 var3 var4 var5 var6 var7 var8 var9 var10 var11 var12 var13
,JM_CELLWIDTH= 0.4 0.35 0.5 0.65 0.5  0.3  0.35 0.4 0.4 0.4 0.4  0.4  0.4
