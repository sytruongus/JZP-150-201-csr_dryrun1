...
* PROGRAM NAME:   	f_cgi_forest_subg
...
proc sql;
   create table caps as 
       ...
       from adam.adqs where paramcd="CGI0201" and .<avisitn<=12 and mfasfl="Y" and anl01fl="Y" 
...
proc sql;
   create table caps_visittyp as 
       ...
       from adam.adqs where paramcd="CGI0201" and .<avisitn<=12 and mfasfl="Y" and anl01fl="Y"  and VISITTYP ne ""
