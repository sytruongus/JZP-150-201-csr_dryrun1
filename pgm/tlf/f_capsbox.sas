...
where parcat1="CAPS-5 Past Week" and paramcd="PTSDTSEV"  and chg ne . and avisit="Week 12" and MFASFL="Y" and anl01fl="Y" order by trtan,chg;
quit;
...
/*layout lattice / rowdatarange=data columndatarange=data rowgutter=10 columngutter=10;*/
	...
	yaxisopts=( LABEL= "Change in CAPS-5" labelfitpolicy=splitalways labelsplitchar='*'  offsetmin=0.05 
