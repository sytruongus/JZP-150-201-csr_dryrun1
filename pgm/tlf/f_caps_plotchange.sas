...
* PROGRAM NAME:   	f_caps_plotchange
...
%fig(dset=adqs,paramcd=%str("PTSDTSEV"));
...
layout overlay / xaxisopts=( LABEL= ('Visit') labelattrs=(family='Courier New' size=7pt )
	...
	yaxisopts=(  LABEL= ('Change from Baseline CAPS-5 Total Score') labelattrs=(family='Courier New' size=7pt ));
