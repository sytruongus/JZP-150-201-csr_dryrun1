...
*Body of table;
*-----------------------------------------------------------------;
proc sort data=adam.adqs2 out=adqs_01(keep= usubjid subjid avisit visit adt ady anl01fl chg paramcd aval);
	by usubjid subjid visit avisit adt;
	where saffl ='Y' and paramcd in  ('ISI0108') ;*and dtype='';
run;
proc sort data=adam.adqs2 out=adqs_02(keep= usubjid subjid SSNRIS visit avisit adt ady parcat1 parcat2 paramcd param age sex race trta trtsdt trtedt aval);
	by trta SSNRIS usubjid subjid visit avisit adt age sex race trtsdt trtedt;
	where saffl ='Y' and  paramcd in  ( "ISI0101" "ISI0102" "ISI0103" "ISI0104" "ISI0105" "ISI0106" "ISI0107") ;*and dtype='';
run;
...
label
	...
	var8= 'ISI01-Total |Score'
	var9= 'Change |from |Baseline'
	var10= 'Difficulty Falling Asleep |Score'
	var11= 'Difficulty Staying Asleep |Score'
	var12= 'Waking up too Early in the Morning |Score'
	var13= 'Satisfi/Dissatisfy your Sleep |Score'
	var14= 'INTERFERE with Daily Functioning |Score'
	var15= 'NOTICEABLE Other Sleep Problem |Score'
	var16= 'WORRIED/distressed Sleep Problem |Score';
