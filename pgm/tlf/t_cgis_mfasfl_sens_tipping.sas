...
VAR SSNRISN BASE WK1 WK4 WK8 WK12;
BY TRTN;
RUN;
...
class TRTN ;
VAR  TRTN SSNRISN BASE WK1 WK4 WK8 WK12; 
MONOTONE REGRESSION (BASE SSNRISN WK1 WK4 WK8 WK12);
BY  _Imputation_;
RUN;
