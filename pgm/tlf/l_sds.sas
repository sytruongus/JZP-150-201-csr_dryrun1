...
proc sort data=adam.adqs2 out=adqs_01(keep= usubjid subjid avisit visit adt ady anl01fl chg paramcd aval);
	...
	where saffl ='Y' and paramcd in  ('SDS0106') ;*and dtype='';
run;
proc sort data=adam.adqs2 out=adqs_02(keep= usubjid subjid SSNRIS visit avisit adt ady parcat1 parcat2 paramcd param age sex race trta trtsdt trtedt aval);
	...
	where saffl ='Y' and  paramcd in  ( "SDS0101" "SDS0102" "SDS0103") ;*and dtype='';
run;
...
/*SDS0101	SDS01-Work/School*/
/*SDS0101A	SDS01-No Work/Study - Unrelated Disorder*/
/*SDS0102	SDS01-Social Life*/
/*SDS0103	SDS01-Family Life/Home Responsibilities*/
/*SDS0104	SDS01-Days Lost*/
/*SDS0105	SDS01-Days Underproductive*/
...
label
	...
	var8= 'SDS - Total |Score'
	var9= 'Change |from |Baseline'
	var10= 'Work/School |Score'
	var11= 'Social Life |Score'
	var12= 'Family Life/Home Responsibilities |Score'
;
...
proc sort data =  qs;
	by SSNRIS trta var1 var2 var3 var4 var5 var6 var7 var8 var9 var10 var11 var12 ;
run;
data qs;
	set qs;
	by SSNRIS trta var1 var2 var3 var4 var5 var6 var7 var8 var9 var10 var11 var12 ;
...
proc sort data=JM_AVAL_ALLREPORT;
    by pageno SSNRIS trta var1 var2 var3 var4 var5 var6 var7 var8 var9 var10 var11 var12 ;
	where usubjid^='';
run;
...
,JM_COL2VAR=  var1 var2 var3 var4 var5 var6 var7 var8 var9 var10 var11 var12 
,JM_CELLWIDTH= 0.4 0.35 0.5 0.65 0.5  0.3  0.35 0.4 0.4 0.4 0.4  0.4 
