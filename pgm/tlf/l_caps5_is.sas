...
proc sort data=adam.adqs out=adqs_01(keep= usubjid subjid avisit visit adt ady anl01fl chg paramcd avalc);
	...
	where saffl ='Y' and paramcd in  ('CA5BTOSV') and dtype='';
run;
proc sort data=adam.adqs out=adqs_02(keep= usubjid subjid SSNRIS visit avisit adt ady paramcd param age sex race trta trtsdt trtedt avalc);
	by trta SSNRIS usubjid subjid visit avisit adt age sex race trtsdt trtedt;
	where saffl ='Y' and paramcd in  ("CA51B1SE","C52B2SEV","C53B3SEV","C54B4SEV","C55B5SEV") and dtype='';
run;
...
data qs;
	...
	var10 = strip(CA51B1SE);
	var11 = strip(C52B2SEV);
	var12 = strip(C53B3SEV);
	var13 = strip(C54B4SEV);
	var14 = strip(C55B5SEV);
...
label
	...
	var10= 'B1 |Intrusive |memories - |Severity |Score'
	var11= 'B2 |Distressing |dreams |Severity |Score'
	var12= 'B3 |Dissociative |reactions - |Severity |Score'
	var13= 'B4 |Cued |psychological |distress - |Severity |Score'
	var14= 'B5 |Cued |physiological |reactions - |Severity|Score';
...
proc sort data =  qs;
	by SSNRIS trta var1 var2 var3 var4 var5 var6 var7 var8 var9 var10 var11 var12 var13 var14;
run;
data qs;
	set qs;
	by SSNRIS trta var1 var2 var3 var4 var5 var6 var7 var8 var9 var10 var11 var12 var13 var14;
...
proc sort data=JM_AVAL_ALLREPORT;
    by pageno SSNRIS trta var1 var2 var3 var4 var5 var6 var7 var8 var9 var10 var11 var12 var13 var14;
	where usubjid^='';
run;
...
,JM_CELLWIDTH= 0.4 0.35 0.5 0.65 0.5  0.3  0.35 0.4 0.4 0.4 0.4  0.4  0.4 0.4
